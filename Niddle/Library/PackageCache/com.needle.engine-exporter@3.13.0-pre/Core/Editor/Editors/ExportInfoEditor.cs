...
namespace Needle.Engine.Editors
{
	...
	public class ExportInfoEditor : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			using (var change = new EditorGUI.ChangeCheckScope())
			{
				...
				using (new EditorGUILayout.HorizontalScope())
				{
					...
					if (GitActions.IsCloneable(directoryNameProperty.stringValue))
					{
						label += " (remote)";
						tooltip = "The git repository to clone.";
					}
					EditorGUILayout.PropertyField(this.directoryNameProperty, new GUIContent(label, tooltip));
			...
			var isRepository = t.DirectoryName.StartsWith("http:") || t.DirectoryName.StartsWith("https:");
		...
		{
			if (GitActions.IsCloneable(t.DirectoryName))
			{
				var isCloning = Tools.IsCloningRepository;
				using (new EditorGUI.DisabledScope(isCloning))
				{
					if (GUILayout.Button("Clone Repository", GUILayout.Height(32)))
					{
