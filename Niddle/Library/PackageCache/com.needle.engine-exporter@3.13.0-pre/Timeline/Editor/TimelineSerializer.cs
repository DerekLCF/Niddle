...
namespace Needle.Engine.Timeline
{
	...
	public static class TimelineSerializer
	{
		...
		public static bool TryExportPlayableAsset(PlayableDirectorExportContext context, TimelineAsset asset, out object result)
		{
			...
			{
				Debug.LogWarning("Timeline has more than " + k_maxStatesAfterTrial + " tracks. Please upgrade to an Indie or Pro Plan of Needle to export more than " + k_maxStatesAfterTrial + " tracks after your trial has ended.", asset);
			}
			foreach (var track in outputTracks)
			{
				if (LicenseCheck.HasLicense == false)
				{
					...
					{
						Debug.LogWarning("Timeline has more than " + k_maxStatesAfterTrial + " tracks. Please upgrade to an Indie or Pro Plan of Needle to export more than " + k_maxStatesAfterTrial + " timeline tracks.");
						break;
					}
				}
