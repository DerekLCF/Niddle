			...
			public AnimatorControllerModel(AnimatorController controller, IGltfBridge bridge, Transform transform, IExportContext context)
			{
				...
				foreach (var layer in controller.layers)
				{
					...
					if (isInTrial && !LicenseCheck.HasLicense)
					{
						...
						{
							Debug.LogWarning("AnimatorController has more than " + k_maxStatesAfterTrial + " states. Please upgrade to an Indie or Pro Plan of Needle to export more than " + k_maxStatesAfterTrial + " states after your trial has ended.", controller);
						}
					}
					...
					for (var index = 0; index < stateMachine.states.Length; index++)
					{
						...
						{
							Debug.LogWarning("AnimatorController has more than " + k_maxStatesAfterTrial + " states. Please upgrade to an Indie or Pro Plan of Needle to export AnimatorControllers with more than " + k_maxStatesAfterTrial + " animation states.");
							continue;
						}
